...
exports["default"] = {
    ...
    "updated_at": "2022-10-27T13:41:45Z",
    "source_locale": {
    ...
    "keys": {
        ...
        "credentialsEncryptionMode_label": "Verschlüsselungsmodus für Zugangsdaten",
        ...
        "generatePassphrase_action": "Passphrase generieren",
        ...
        "howtoMailBody_markdown": "Tutanota ermöglicht dir verschlüsselte E-Mails an jede E-Mail-Adresse weltweit zu senden – automatisch, wenn der andere ebenfalls Tutanota nutzt, oder über ein ausgetauschtes Passwort, wenn die Empfänger*innen einen anderen Service benutzen. Selbst unverschlüsselte E-Mails werden verschlüsselt auf unseren eigenen Servern in Deutschland gespeichert.\n\nBitte schau dir unsere FAQ und unser Support-Forum an, um alles über deine neue sichere Mailbox zu erfahren:\n\n* [FAQ]({faqLink})\n* [Support-Forum]({redditLink})\n\n**Suche in verschlüsselten Daten**\n\nTutanota lässt dich deine verschlüsselte Mailbox lokal auf deinem Gerät durchsuchen, um die Vertraulichkeit zu gewährleisten. Bitte klicke dazu auf das Suchfeld in der oberen Menüleiste. Die Standard-Suche geht bis einen Monat in die Vergangenheit zurück. [Um eine unlimitierte Suche sowie zahlreiche weitere Funktionen zu bekommen]({blogPremiumProLink}), wechsel bitte zu einer bezahlten Version von Tutanota unter Einstellungen -> Abonnement. \n\n**Direkter Support**\n\nTutanota ermöglicht jedem vertrauliche E-Mails zu senden. Mit Millionen Nutzern weltweit können wir leider nicht jede Frage per E-Mail beantworten. Wenn du die Antworten zu deinen Fragen nicht in unseren FAQ und in unserer Anleitung findest, [frage bitte die Tutanota-Community um Hilfe]({redditLink}). Direkter Support per E-Mail ist nur für zahlende Kunden verfügbar.\n\nViele Grüße,\\\ndein Tutanota-Team",
        ...
        "pricing.comparisonAddUser_msg": "Benutzer*innen hinzubuchen ({1})",
        ...
        "subscriptionPeriodInfoBusiness_msg": "Die Vertragslaufzeit beträgt einen Monat bei monatlicher Zahlung und ein Jahr bei jährlicher Zahlung. Die Vertragslaufzeit wird nach Ende der Laufzeit automatisch verlängert.",
