...
exports["default"] = {
    ...
    "updated_at": "2022-10-25T13:40:07Z",
    "source_locale": {
    ...
    "keys": {
        ...
        "acceptTemplateGroupEmailBody_msg": "مرحبًا {recipientName} ،<br/> لقد قبل {invitee} دعوتك لاستخدام قائمة النماذج '{groupName}'.<br/><br/> هذه هي رسالة تلقائية.",
        ...
        "accountSwitchFeature_msg": "يرجى إلغاء تنشيط الميزة {featureName}.",
        ...
        "addCustomDomainAdresses_msg": "تم تعيين المجال لحسابك. لاستخدام نطاقك المخصص ، يرجى إضافة اسم مستعار للبريد الإلكتروني واحد على الأقل إلى المستخدم الحالي. وبدلاً من ذلك ، يمكنك إضافة مستخدمين جدد بعنوان بريد إلكتروني مخصص للنطاق.",
        "addCustomDomainAliases_msg": "أضف اسمًا مستعارًا للبريد الإلكتروني لصندوق بريدك الحالي إذا كنت بحاجة إلى عنوان بريد إلكتروني آخر لنفسك.",
        "addCustomDomainUsers_msg": "أضف مستخدمين جددًا أو أسماء مستعارة جديدة للبريد الإلكتروني للمستخدمين الحاليين إذا كنت بحاجة إلى عناوين بريد إلكتروني لأشخاص آخرين.",
        ...
        "all_label": "كل",
        "alreadyMember_msg": "أنت بالفعل مشارك في هذا التقويم. إذا كنت ترغب في قبول هذه الدعوة الجديدة ، فيجب عليك إزالة مشاركتك أولاً.",
        "alreadyReplied_msg": "لقد رددت على هذه الدعوة.",
        "alreadyTemplateGroupMember_msg": "أنت تستخدم بالفعل مجموعة النماذج هذه. سيتعين عليك إزالة نفسك من المجموعة قبل أن تتمكن من قبول هذه الدعوة",
        ...
        "businessBooking_label": "ميزة الأعمال لـ {1} مستخدمين",
        "businessChangeInfo_msg": "يرجى التحقق من بيانات الفاتورة الخاصة بك لتتمكن من تحويل حسابك إلى حساب الشركات التجارية. ",
        "businessCustomerAutoBusinessFeature_msg": "لاحظ أنه سيتم حجز ميزة الأعمال تلقائيًا مع جميع الاشتراكات لعملاء الأعمال.",
        "businessCustomerNeedsBusinessFeaturePlan_msg": "خطة اشتراكك الحالية هي {plan} ({price}) بدون ميزة الأعمال.",
        "businessDeletionWarning_msg": "سيتم إلغاء تنشيط ميزة الأعمال لجميع المستخدمين الآن. سيتم تعطيل إعلام خارج المكتب ودعوات التقويم. يُسمح بمجال بريد إلكتروني مخصص واحد فقط.",
        "businessFeatureRequiredGeneral_msg": "لاستخدام هذه الوظيفة ، يجب عليك طلب ميزة الأعمال.",
        "businessFeatureRequiredInvite_msg": "لإرسال دعوات الحدث ، يجب عليك طلب ميزة الأعمال.",
        "businessFeatureRequiredMultipleDomains_msg": "لإضافة عدة مجالات بريد إلكتروني مخصصة ، يجب عليك طلب ميزة الأعمال.",
        "businessFeatureRequiredTemplates_msg": "لاستخدام النماذج ، ميزة الأعمال مطلوبة.",
        "businessFeature_label": "ميزة الأعمال",
        "businessIncluded_msg": "يتم تضمين ميزة الأعمال.",
        "businessOrPrivateUsage_label": "الاستخدام",
        "businessUseUpgradeNeeded_msg": "عذرًا ، لا يُسمح لك حاليًا بإرسال أو استقبال رسائل البريد الإلكتروني (باستثناء دعم مبيعات توتانوتا على sales@tutao.de) لأن لديك حسابًا تجاريًا مسموحًا به فقط مع الاشتراكات المدفوعة. الرجاء الترقية إلى اشتراك مدفوع الآن.",
        ...
        "cancelBusinessBooking_label": "إلغاء ميزة الأعمال لـ {1} مستخدمين",
        ...
        "cancelSharingBooking_label": "إلغاء ميزة المشاركة لـ {1} مستخدمين",
        ...
        "certificateType_label": "نوع الشهادة",
        ...
        "clickHereForMoreInfo_msg": "انقر هنا لمزيد من المعلومات",
        ...
        "close_alt": "إغلاق",
        "codeInput_msg": "أدخل رمز بطاقة هدية ",
        "color_label": "اللون",
        ...
        "confirmLeaveTemplateGroup_msg": "هل أنت متأكد أنك تريد التوقف عن استخدام قائمة النماذج هذه؟ سيتعين على المالك إعادة دعوتك.",
        ...
        "connectionLost_msg": "فُقد الاتصال.",
        ...
        "customTemplateListName_label": "اسمك المخصص لقائمة النماذج هذه : {customName}",
        "custom_label": "مخصص",
        "cut_action": "قص",
        "dark_label": "داكن ",
        ...
        "declineTemplateGroupEmailBody_msg": "مرحبًا {recipientName} ، <br/> رفض {invitee} دعوتك لاستخدام قائمة النماذج '{groupName}'. <br/><br/> هذه هي رسالة آلية.",
        ...
        "defaultShareGiftCardSubject_msg": "لقد تلقيت بطاقة الهدية من توتانوتا !",
        ...
        "deleteDnsRecords_msg": "يرجى حذف أو إصلاح سجلات DNS التالية:",
        ...
        "deleteTemplateGroup_msg": "هل أنت متأكد أنك تريد حذف قائمة النماذج الخاصة بك؟",
        "deleteTemplate_msg": "هل أنت متأكد أنك تريد حذف هذا النموذج؟",
        "delete_action": "حذف",
        "deletionWarningTitle_msg": "تحذير الحذف",
        "deletionWarning_msg": "يرجى ملاحظة أنه سيتم حذف الحسابات المجانية إذا لم يتم استخدامها لأكثر من ستة أشهر. لا يتم حذف حسابات المستخدمين الذين يدفعون. اقرأ المزيد عما تحصل عليه من اشتراكاتنا المدفوعة : ",
        ...
        "dnsRecordsOk_msg": "جميع سجلات DNS على ما يرام!",
        ...
        "eventCopy_msg": "تم إرسال هذا الحدث من تقويم آخر. ستكون التغييرات على الحدث مرئية فقط في التقويم الخاص بك.",
        ...
        "fax_label": "فاكس",
        "featureRequiredForBusinessUse_msg": "هذه الميزة مطلوبة للاستخدام التجاري.",
        ...
        "firstReminderAutomatic_msg": "لسوء الحظ ، لم نتلق المبلغ الخاص بحسابك توتانوتا حتى الآن. لذلك ، نطلب منك التحقق من تفاصيل الدفع الخاصة بك في 'الإعدادات' -> 'الدفع'. لمزيد من التفاصيل ، يمكنك أيضًا التحقق من فواتيرك على تلك الصفحة.",
        ...
        "giftCardUpgradeNotify_msg": "ستتم ترقيتك تلقائيًا إلى حساب Premium من خلال اشتراك سنوي. سيتم دفع تكلفة السنة الأولى ({price}) ببطاقة هدية الخاصة بك وسيتم إضافة القيمة المتبقية ({credit}) إلى حسابك.",
        ...
        "howtoMailBody_markdown": "يتيح لك برنامج توتانوتا إرسال رسائل بريد إلكتروني مشفرة إلى أي عنوان بريد إلكتروني في العالم - تلقائيًا إذا كان المستلم يستخدم برنامج توتانوتا أيضًا ، أو عبر كلمة مرور مشتركة إذا كان المستلم يستخدم خدمة أخرى. حتى رسائل البريد الإلكتروني المرسلة أو المستلمة غير المشفرة يتم تخزينها على خوادمنا الموجودة في ألمانيا.\n\nيرجى مراجعة الأسئلة الشائعة حول توتانوتا ومنتدى الدعم لمعرفة كل ما تريد معرفته عن صندوق البريد الآمن الجديد : \n* [الأسئلة الشائعة]({faqLink})\n* [منتدى الدعم]({redditLink})\n\n** البحث في البيانات المشفرة **\n\nيتيح لك توتانوتا البحث في صندوق البريد المشفر محليًا على جهازك لضمان سرية بياناتك. يرجى النقر على شريط البحث في الأعلى. يعود البحث القياسي إلى شهر واحد في الماضي. [لإلغاء قفل البحث غير المحدود والكثير من الميزات الإضافية في صندوق بريد توتانوتا]({blogPremiumProLink}) ، يرجى التبديل إلى اشتراك مدفوع في توتانوتا ضمن الإعدادات -> الاشتراك.\n\n**الدعم المباشر**\n\nفي توتانوتا ، يمكننا تمكين الجميع في العالم من إرسال رسائل البريد الإلكتروني بشكل سري. مع ملايين المستخدمين ، لا يمكننا الإجابة على أسئلة الجميع عبر البريد الإلكتروني. إذا لم تتمكن من العثور على إجابات لأسئلتك في الأسئلة الشائعة والدليل ، [يرجى ارسال سؤال للمجتمع هنا]({redditLink}). يقتصر الدعم عبر البريد الإلكتروني على مستخدمي  بريميوم أو برو. \n\nابق آمنًا ، \\\n فريق توتانوتا\n\n\n",
        ...
        "importExport_action": "استيراد/تصدير",
        ...
        "invalidInterval_msg": "فاصل غير صالح",
        ...
        "invitationMailSubject_msg": "عنوان بريدي الإلكتروني الجديد - انضم إلى توتانوتا حتى نتمكن من استعادة خصوصيتنا",
        ...
        "mailAuthFailed_label": "فشلت المصادقة على البريد",
        ...
        "merge_action": "دمج",
        "messageTooLong_msg": "الرسالة طويلة جدًا. الحد الأقصى المسموح به لعدد الأحرف هو {length}",
        "message_label": "رسالة ",
        ...
        "onlyAvailableForPremiumNotIncluded_msg": "لا يمكن طلب هذه الميزة إلا بعد الترقية إلى اشتراك مدفوع. يرجى ترقية حسابك الآن.",
        "onlyAvailableForPremium_msg": "هذه الميزة متاحة فقط مع الاشتراك المدفوع. يرجى ترقية حسابك الآن.",
        ...
        "ordertItNow_msg": "هل ترغب في طلب الميزة الآن؟",
        "order_action": "الطلب",
        "organizer_label": "منظم ",
        "originalPrice_label": "السعر الأصلي",
        "otherCalendars_label": "التقاويم الأخرى",
        "otherPaymentProviderError_msg": "مزود خدمة الدفع عاد بخطأ. يرجى المحاولة لاحقا.",
        "other_label": "آخر",
        "outdatedClientWarningMailBody_msg": "مرحبًا ، <br>\n\nأنت تستخدم حاليًا إصدارًا قديمًا من توتانوتا. سيتم إيقاف دعم نسختك في غضون الأيام القليلة القادمة. br><br>\n\n\nيرجى تحديث عميلك على : {downloadLink} <br><br>\n\nيرجى أيضا التحقق مما إذا كنت تستخدم إصدارا قديما من توتانوتا على جهاز مختلف. سيتوقف النظام عن إرسال هذا البريد الإلكتروني بمجرد تحديث جميع عملاء توتانوتا. <br><br>\n\nشكرًا! <br><br>\n\nفريقك في توتانوتا",
        "outdatedClientWarningMailSubject_msg": "يرجى تحديث توتانوتا",
        ...
        "participants_label": "المشاركون في التقويم \"{name}\"",
        ...
        "phishingMessage_label": "تبدو هذه الرسالة مشبوهة.",
        ...
        "priceOfferEnded_label": "انتهى العرض الخاص. يرجى حجز توتانوتا بالأسعار العادية.",
        "priceSpecialOffer_label": "عرض توتانوتا : مدة عام مجانا",
        ...
        "pricing.comparisonMultipleCalendars_msg": "تقاويم متعددة",
        ...
        "recommendedDmarcRecord_msg": "نوصي بتعيين إدخال TXT التالي لـ DMARC ، لكن يمكنك أيضًا اختيار التكوين الخاص بك:",
        ...
        "redeemedToPremium_msg": "لديك الآن حساب بريميوم.",
        "redeem_label": "‪ استردّ",
        "redo_action": "إعادة",
        ...
        "removeTemplateGroupMemberConfirm_msg": "هل أنت متأكد من أنك تريد إزالة {member} كمستخدم لقائمة النماذج '{groupName}' ؟",
        ...
        "savedCredentialsError_msg": "فشل استخدام بيانات الاعتماد المحفوظة لتسجيل الدخول",
        ...
        "saveDraftAndClose_action": "احفظ المسودة وأغلق",
        ...
        "secondReminderAutomatic_msg": "لسوء الحظ ، لم نتلق بعد مدفوعات حسابك توتانوتا الخاص بك. لذلك ، نطلب منك التحقق من تفاصيل الدفع الخاصة بك في  'الإعدادات' -> 'الدفع'. لمزيد من تفاصيل الفاتورة ، يمكنك أيضًا التحقق من فواتيرك على تلك الصفحة. يتعين علينا إلغاء تنشيط حسابك إذا لم نستلم المبلغ خلال أسبوعين.\n",
        ...
        "selectRecipientCountry_msg": "حدد بلد المستلم",
        ...
        "shareCalendarWarningAliases_msg": "سيتمكنون أيضًا من رؤية الأسماء المستعارة للبريد الإلكتروني المرتبطة بصندوق البريد الخاص بك.",
        ...
        "sharedCalendarExisting_msg": "لا تزال تشارك التقويمات. الرجاء إزالة جميع المشاركات أولاً.",
        ...
        "shareTemplateGroupWarning_msg": "سيتمكن جميع مستخدمي قائمة النماذج  من رؤية اسمك وعنوان البريد الإلكتروني الرئيسي لصندوق البريد الخاص بك.",
        "shareViaEmail_action": "مشاركة عبر البريد الإلكتروني",
        "shareWithEmailRecipient_label": "مشاركه مع مستلم البريد الكتروني",
        "share_action": "شارك",
        "sharingBooking_label": "ميزة المشاركة لـ {1} مستخدمين",
        "sharingDeletionWarning_msg": "سيتم حذف كافة مشاركات جميع المستخدمين تلقائيًا عند تعطيل ميزة المشاركة.",
        "sharingFeatureNotOrderedAdmin_msg": "لمشاركة التقويم ، يجب عليك طلب ميزة المشاركة. هل ترغب في طلبها الآن؟",
        "sharingFeatureNotOrderedUser_msg": "لمشاركة التقويم ، يجب عليك طلب ميزة المشاركة.",
        "sharingFeature_label": "ميزة المشاركة",
        "sharing_label": "مشاركة ",
        "shortcut_label": "الاختصار",
        "showAddress_alt": "إظهار هذا العنوان في خرائط \"أوبن ستريت ماب\"",
        "showAll_action": "إظهار الكل",
        ...
        "sign_action": "توقيع",
        "skipDnsRecordsInfo_msg": "يرجى ضبط سجلات DNS لنطاق بريدك الإلكتروني المخصص. طالما لم يتم تكوينها بشكل صحيح، فقد لا تتمكن من إرسال واستقبال رسائل البريد الإلكتروني. ومع ذلك، يمكنك تأجيل هذه الخطوة حتى تقوم في البداية بإعداد عناوين بريدك الإلكتروني.",
        "skip_action": "تجاوز",
        ...
        "subscriptionPeriodInfoBusiness_msg": "مدّة الاشتراك هي شهر واحد عند الدفع الشهري وسنة واحدة عند الدفع سنويا. سيتم تجديد الاشتراك تلقائيا في نهاية مدّة الاشتراك.",
        "subscriptionPeriodInfoPrivate_msg": "مدّة الاشتراك هي شهر واحد عند الدفع الشهري وسنة واحدة عند الدفع سنويا. بعد المدّة الأولية، سيتحول الاشتراك إلى عقد غير محدد المدة ويمكن إلغاؤه في أي وقت.",
        ...
        "takeoverMailAddress_label": "عنوان الحساب المستهدف",
        ...
        "technicalSender_msg": "المرسل الفني هو : {sender}",
        "templateGroupDefaultName_label": "نماذجي",
        "templateGroupHasMember_msg": "يرجى إزالة جميع الأعضاء إذا كنت تريد حذف المجموعة.",
        "templateGroupInvitations_label": "قائمة النماذج للدعوات ",
        "templateGroupName_label": "اسم قائمة النماذج",
        "templateGroupParticipants_label": "مستخدموا قائمة النماذج \"{groupName}\"",
        ...
        "templateSharingNotOrdered_msg": "لمشاركة قائمة النماذج ، يجب أن يكون لديك ميزة المشاركة. هل تريد أن تطلبها الآن؟",
        ...
        "terminationSubject_msg": "إنهاء حسابك",
        ...
        "timeFormatInvalid_msg": "تنسيق الوقت غير صالح",
        ...
        "userManagementRedirect_msg": "ستتم إعادة توجيهك إلى قائمة إعدادات المستخدم. يمكنك لاحقًا استئناف عملية الإعداد لنطاقك المخصص.",
        ...
        "validGiftCardCountry_msg": "بطاقة الهدية هذه صالحة فقط للاستخدام في {valid} ولكننا اكتشفنا أنك في {actual}. الرجاء التأكيد أنك تستخدم بطاقة الهدية هذه في {valid}.",
        "validInCountry_msg": "صالحة في {country}.",
        ...
        "whitelabelFeature_label": "ميزة العلامة البيضاء",
