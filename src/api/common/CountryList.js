...
exports.getDecimalSeparator = exports.getByAbbreviation = exports.Countries = exports.DecimalSeparator = exports.CountryType = void 0;
exports.CountryType = {
    GERMANY: 0,
    EU: 1,
    OTHER: 2
...
function getByAbbreviation(abbreviation) {
    var _a;
    return (_a = exports.Countries.find(function (c) { return c.a === abbreviation; })) !== null && _a !== void 0 ? _a : null;
}
exports.getByAbbreviation = getByAbbreviation;
function getDecimalSeparator(abbreviation) {
    var country = getByAbbreviation(abbreviation);
    if (country) {
        return country.d === exports.DecimalSeparator.DOT ? "." : ",";
    }
    else {
        return ",";
    }
