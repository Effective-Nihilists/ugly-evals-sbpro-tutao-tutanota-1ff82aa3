...
function iosCopyToClipboard(text) {
    ...
    s === null || s === void 0 ? void 0 : s.addRange(range);
        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                ...
                case 2:
                    ...
                    if (ClientDetector_1.client.isIos()) {
                        return [2 /*return*/, iosCopyToClipboard(text)];
                    }
                    else {
                        return [2 /*return*/, fallbackCopyToClipboard(text)];
                    }
                    return [3 /*break*/, 3];
